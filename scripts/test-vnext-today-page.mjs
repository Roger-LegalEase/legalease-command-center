...
assert.equal(createHash("sha256").update(serverSource.slice(legacyShellStart, legacyShellEnd)).digest("hex"), "cec80c07192bef3d4b902050b43b2bf0c7f337c4a4b7f8a51d54c280adff45e6", "Legacy flag-off shell must remain byte-for-byte unchanged.");
