...
export function buildDataModelInventory() {
  return [
    ...
    },
    {
      ...
      optional_fields: ["email", "payment_status", "source_type", "source_record_id", "import_id", "created_at"],
      stable_key_fields: ["id"],
