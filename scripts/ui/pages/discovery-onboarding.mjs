...
export function renderDiscoveryOnboarding(contract = {}) {
  ...
  return `<section class="discovery-onboarding" data-discovery-onboarding data-preference-version="${escapeAttribute(contract.preference?.version || 0)}" aria-labelledby="discovery-onboarding-title"${contract.shouldOpen === false ? " hidden" : ""}>
