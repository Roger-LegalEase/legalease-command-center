...
assert(serverSource.includes("Notes & Decisions"), "Notes & Decisions label must exist.");
...
assert(serverSource.includes("Save Today's Notes"), "Review-only save button must render.");
