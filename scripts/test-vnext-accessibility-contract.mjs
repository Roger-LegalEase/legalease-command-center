...
const files = [
  ...
  "assets/ui/founder-scoreboard.css", "assets/ui/founder-support.css", "assets/ui/founder-calendar.css",
  "assets/ui/founder-company-health.css", "assets/ui/files-home.css", "assets/ui/investor-room.css",
  "assets/ui/quick-capture.css"
];
...
const pages = (await Promise.all([
  ...
  "scripts/ui/pages/outreach-home.mjs", "scripts/ui/pages/partners-home.mjs", "scripts/ui/pages/founder-scoreboard.mjs",
  "scripts/ui/pages/founder-support-page.mjs", "scripts/ui/pages/founder-calendar-page.mjs",
  "scripts/ui/pages/founder-company-health.mjs", "scripts/ui/pages/files-home.mjs"
...
for (const name of ["Today", "Inbox", "Relationships", "Social", "Outreach", "Scoreboard", "Support", "Calendar", "Company Health", "Files"]) {
...
console.log("VNEXT_ACCESSIBILITY_EVIDENCE", JSON.stringify({ widths:[1440,1280,1024,768,390], primarySurfaces:10, overlays:["Search","Create","Discovery"], serious:0, critical:0 }));
