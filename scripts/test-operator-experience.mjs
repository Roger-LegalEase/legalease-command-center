...
assert.match(server, /<summary class="nav-menu-summary" data-nav-section="growth">Growth<\/summary>/, "Simplified nav should expose Growth.");
...
assert.match(server, /<summary class="nav-menu-summary" data-nav-section="production">Production<\/summary>/, "Simplified nav should expose Production.");
...
assert.match(server, /<summary class="nav-menu-summary" data-nav-section="more">More<\/summary>/, "Simplified nav should expose More.");
