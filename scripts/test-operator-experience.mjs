...
assert.match(server, /<summary class="nav-menu-summary" data-nav-section="work">Work<\/summary>/, "Simplified nav should expose Work.");
assert.match(server, /<summary class="nav-menu-summary" data-nav-section="partners">Partners<\/summary>/, "Simplified nav should expose Partners.");
assert.match(server, /<summary class="nav-menu-summary" data-nav-section="proof">Proof<\/summary>/, "Simplified nav should expose Proof.");
assert.match(server, /<summary class="nav-menu-summary" data-nav-section="system">System<\/summary>/, "Simplified nav should expose System.");
assert.match(server, /class="nav-top-link" href="#operator-search" data-nav-section="search"/, "Simplified nav should expose Search.");
...
assert.match(server, /document\.addEventListener\("click", \(event\) =>/, "Navigation should wire outside-click closing.");
...
assert.match(server, /href="#os-health">System Health/, "System Health should be discoverable in the System menu.");
assert.match(server, /href="#morning-brief">Morning Brief/, "Morning Brief should be discoverable in the System menu.");
assert.match(server, /href="#capture-inbox">Captures/, "Captures should be discoverable in the Work menu.");
