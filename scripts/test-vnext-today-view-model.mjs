...
assert.equal(createHash("sha256").update(serverSource.slice(shellStart, shellEnd)).digest("hex"), "cec80c07192bef3d4b902050b43b2bf0c7f337c4a4b7f8a51d54c280adff45e6", "Legacy flag-off shell must not drift outside the reviewed reactivation-control change.");
