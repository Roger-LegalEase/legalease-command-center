...
assert.match(updated.assistant.content, /Updated ‘Goodwill’ to ‘We Must Vote\.’/, "Le-E should confirm the visible update.");
...
assert.match(notFound.assistant.content, /I could not find ‘Missing Phrase’ on this page, so I saved your request as a note\./, "Le-E should explain when nothing was updated.");
